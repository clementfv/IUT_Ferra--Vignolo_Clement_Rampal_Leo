...
while (1) {
    ...
    payloadIR[0] = (unsigned char) robotState.distanceTelemetreGauche;
    payloadIR[1] = (unsigned char) robotState.distanceTelemetreCentre;
    payloadIR[2] = (unsigned char) robotState.distanceTelemetreDroit;
